...
3. Once you are done making changes, [create a pull request](https://github.com/Venekiel/Origins-Vampire/compare/latest...latest). See [Naming conventions > Pull requests](#) for naming conventions.
